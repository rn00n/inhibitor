...
import com.rn00n.inhibitor.application.auth.grant.registry.AuthenticationGrantBinding
import com.rn00n.inhibitor.application.auth.grant.registry.GrantTypeRegistry
import com.rn00n.inhibitor.application.auth.grant.revoke.CustomTokenRevocationAuthenticationProvider
import com.rn00n.inhibitor.application.auth.handler.DefaultOAuth2AuthenticationFailureHandler
import com.rn00n.inhibitor.application.auth.handler.OriginOAuth2ClientAuthenticationFailureHandler
import com.rn00n.inhibitor.application.auth.oidc.OidcUserInfoMapper
