...
import com.rn00n.inhibitor.infrastructure.security.authentication.grant.origin.password.OAuth2OriginPasswordGrantAuthenticationProvider
import com.rn00n.inhibitor.infrastructure.security.authentication.grant.origin.refresh.OAuth2OriginRefreshTokenAuthenticationProvider
import com.rn00n.inhibitor.infrastructure.security.authentication.grant.origin.reissue.OAuth2OriginReissueTokenAuthenticationProvider
import com.rn00n.inhibitor.application.auth.service.userdetails.ExtendedUserDetailsService
import com.rn00n.inhibitor.infrastructure.security.authentication.support.CustomOAuth2ConfigurerSupport
