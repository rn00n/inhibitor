package com.rn00n.inhibitor.infrastructure.security.authentication.grant.origin.reissue

import com.rn00n.inhibitor.infrastructure.security.authentication.grant.ExtendedAuthorizationGrantType
import com.rn00n.inhibitor.infrastructure.security.authentication.token.OAuth2OriginReissueTokenAuthenticationToken
...
class OAuth2OriginReissueTokenAuthenticationConverter : AuthenticationConverter {

    private val supportedGrantTypes = setOf(
        ExtendedAuthorizationGrantType.ORIGIN_REISSUE_TOKEN.value,
    )
    ...
    override fun convert(request: HttpServletRequest): Authentication? {
        ...
        return OAuth2OriginReissueTokenAuthenticationToken(
